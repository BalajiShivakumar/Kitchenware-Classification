...
batch_size = 32
epochs = 5
base_path = '/Users/balajisivakumar/Downloads/'
...
class MainWindow(QMainWindow):
    ...
    def submit_feedback(self):
        ...
        if expected_class_index is not None:
            ...
            if model_update:
                user_image_path = os.path.join(base_path, 'userInput')
...
train_data_path = os.path.join(base_path, 'Images', 'train')
test_data_path = os.path.join(base_path, 'Images', 'test')
...
model = tf.keras.models.load_model(os.path.join(base_path, 'TrainedModel', 'kitchenware_trainedmodel.keras'))
...
model.save(os.path.join(base_path, 'TrainedModel', 'kitchenware_trainedmodel.keras'))